...
class MainGui_tk(tkinter.Tk):
    ...
    def initialize_gui(self):
        ...
        self.logo_fname = dirname(abspath(__file__)) + '/../data/logo.gif'
    ...
    def OnButtonLoadDicom(self):
        ...
        self.dicom_file_path = tkinter.filedialog.askdirectory(initialdir='/opt/DataSet/') + '/'
        try:
...
class SimpleApp_tk(tkinter.Tk):
    ...
    def initialize(self):
        ...
        self.txtVariable.set("Enter text here")
        
        self.button = tkinter.Button(self, text='Click me!',
