        ...
        for fcount, img_file in enumerate(tqdm(self.ls_all_patients)):
            ...
            if mini_df.shape[0] > 0:  # 有些病人可能没有结节，跳过这些病人some files may not have a nodule--skipping those
                ...
                for node_idx, cur_row in mini_df.iterrows():
                    ...
                    np.save(os.path.join(self.tmp_workspace, "%s_%04d_%04d_%04d.npy" % (cur_row["seriesuid"],fcount, node_idx,i_z)), slice)
                    np.save(os.path.join(self.tmp_workspace, "%s_%04d_%04d_%04d_o.npy" % (cur_row["seriesuid"],fcount, node_idx,i_z)),nodule_mask)
                    #===================================
